...
La libreria Web3.py raccoglie un insieme esteso di funzioni per monitorare e svolgere operazioni su alcune catene blockchain. Essa permette la creazioni di nuovi blocchi e nuovi wallet. Permette inoltre operazioni piuttosto avanzate. \
...
Sono state esaminate quattro piattaforme di interesse. Queste sono molto diverse tra loro. \
Esse sono adatte a diversi tipi di utenti, offrono diverse funzionalità, richiedono diverse competenze e sono adatte a diversi utilizzi. 
Questi diversi aspetti sono esaminate in maggiore dettaglio.
...
- Da quello che si può vedere dalla tabella le quattro piattaforme forniscono lo stesso supporto. 
- Web3.py è l'unica che permette di svolegere la transazione direttamente, ma si occupa solo di alcune catene. \
- Complessivamente, sembrerebbe che la piattaforma Ethereum è la più adatta per un utente casuale che svolge attività sulla catena Ethereum.
- Per chi svolge attività su altre catene e non ha competenze di programmazione, nessuna delle due piattaforme rimanenti potrebbe essere abbastanza accessibile.
- 

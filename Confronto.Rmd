...
Oltre alle euristiche di Nielsen sono state identificate alcune figure che potrebbero utilizzare le piattaforme analizzate. Sono state formulate delle domande specifiche in modo da inquadrare in modo preciso gli strumenti. \
...
- **Utenti individuali**: un individuo, che gestisce la sua finanzia personale e fa piccoli investimenti. Questo utente vorrà poter monitorare le sue attività, prendere decisioni di inverstimento, portare avanti piccole operazioni. \
  ...
  Se è possibile trovare informazioni considerate utili per prendere decisioni di investimento. Esempi di informazioni rilevanti per prendere decisioni sono il prezzo del gas e il costo di una operazione. \
  - *Un utente può utilizzare lo strumento per svolgere operazioni ?* \
  Se è possibile completare una singola transazione dal proprio wallet direttamente sulla piattaforma o utilizzando la libreria. \
...
- **Sviluppatori dApp**: Chi sviluppa dApp vorrà poter creare la dApp, lanciare la dApp, fare auditing/valutazione della dApp.
  ...
  Se lo strumento permette di fare il deploy di una dApp sulla blockchain. \
  - *Uno sviluppatore può fare auditing/valutazione della propria dApp ?* \
  Se lo strumento permette ad uno sviluppatore di svolgere attività di auditing o valutazione della propria dApp. Esempi di auditing o valutazioni sono [...] \
- **Sviluppatori di smart contract** : Chi scrive o fa auditing di smart contract avrà interesse a scrivere il codice, lanciare il codice, e verificare il codice. \
  ...
  Se lo strumento fornisce strumenti per scrivere o compilare il codice di uno smart contract. \
  - *Uno sviluppatore può lanciare il proprio smart contract sulla blockchain ?* \
  Se lo strumento permette di lanciare uno smart contract sulla blockchain. \
  - *Uno sviluppatore può verificare il codice del proprio smart contract ?* \
  Se lo strumento permette di confrontare il bytecode presente sulla catena con il bytecode generato localmente. \
...
- **Minatori e Validatori** : chi fa mining e validazione di blocchi sulle catene supportate. Chi si occupa di minare e validare i blocchi vorrà poter monitorare la produzione di blocchi, confermare delle transazioni, monitorare la salute della rete, monitorare le attività della rete. \
  ...
  Lo piattaforma o libreria fornisce mezzi per partecipare allo staking. \
  - *Un minatore o validatore ha accesso a strumenti per effettuare il mining ?* \
  Lo piattaforma o libreria fornisce mezzi per partecipare allo mining. \
  - *Un minatore o validatore può stimare il slashing risk ?* \
  Lo strumento permette di ottenere informazioni sullo slashing risk in caso di penalità. \
  - *Un minatore o validatore può conoscere la validator uptime ?* \
  Lo strumento permette di conoscere la validator uptime. \
  - *Un minatore o validatore può stimare la reward rate ?* \
  Lo strumento permette di stimare la reward rate per la attività di mining. \
  - *Un minatore o validatore può ottenere informazioni sulla liquidity ?* \
  Lo strumento permette informazioni sulla liquidity. \
...
- **Analisti e ricercatori di cryptovalute** : ci sono due figure, gli analisti di mercato e i ricercatori di blockchain. Gli analisti vorrano poter monitorare i movimenti di mercato. I ricercatori di blockchain vorranno poter esplorare i dati della blockchain, analizzare le tendenze dei volumi delle transazioni, dei prezzi del gas, dei movimenti dei token. \
  ...
  Lo strumento fornisce informazioni riguardanti il numero di dApp attive sulla blockchain. \
  - *Un analista può conoscere gli smart contracts attivi sulla blockchain ?* \
  Lo strumento fornisce informazioni riguardanti i smart contract attivi sulle blockchain. \
  ...
  Lo strumento può interagire con soluzioni layer 2. \
  - *Un analista può conoscere i governance models utilizzati sulla blockchain ?* \
  Lo strumento permettere ottenere informazioni riguardanti i governance models utilizzati sulla blockchain. \
...
- **Team di progetti (DeFi, NFT, Progetti Token)** : ci sono tre casi, le piattaforme di finanza decentralizzata, i creatori e le piattaforme di NFT, i team di ICO. Le piattaforme di finanza decentralizzata utilizzano Etherscan per monitorare la liquidità dei token, le transazioni e le statistiche dei pool di liquidità. Chi crea NFT vorrà poter creare l'NFT, fare mining, fare operazioni e monitorare lo stato. I team ICO vorranno poter lanciare i token o airdrop, monitorare la distribuzione dei token, verificare le interazioni con gli smart contract e gestire la tokenomica del progetto.
  ...
  Lo strumento permette di ottenere informazioni riguardo la liquidità dei token. \
  - *Un team può conoscere le transazioni e le statistiche dei pool di liquidità ?* \
  Lo strumento permette di ottenere informazioni riguardo le transazioni e le statistiche dei pool di liquidità. \
  - *Un team può creare l'NFT ?* \
  Lo strumento permette di creare un NFT in qualche modo. \
  - *Un team può fare minting di NFT ?* \
  Lo strumento permette di fare il minting di un NFT. \
  - *Un team può lanciare i token o airdrop ?* \
  Lo strumento permette di lanciare token o airdrop. \
  - *Un team può monitorare la distribuzione dei token ?* \
  Lo strumento permette di ottenere informazioni riguardo la distribuzione di un token. \
  - *Un team può verificare le interazioni con gli smart contract?* \
  Lo strumento permette di verificare le interazioni con gli smart contract. \
  - *Un team può gestire la tokenomica del progetto ?* \
  La piattaforma o libreria fornisce strumenti per gestire la tokenomica di un progetto. Per tokenomica si intende lo studio e l’analisi di aspetti economici di una crittovaluta o progetto blockchain. Esempi di informazioni sono il numero totale di token in circolazione, i meccanismi di distribuzione, i meccanismi di minting e burning. \
...
Come accennato nell'introduzione, la blockchain ha un'utenza diversificata e i diversi strumenti soddisfano le esigenze di utenze diverse. Per ciascuna piattaforma si cerca di identificare a che tipo di utenza è rivolta.
...
La pagina *Vyper Online Compiler* propone un compilatore online di linguaggio Vyper. &Egrave; possibile specificare la versione da utilizzare. La pagina *Bytecode to Opcode* propone una pagina dove è possibile decodificare il bytecode di basso livello a opcode. La pagina *Broadcast Transaction* propone una pagina dove è possibile trasmettere una Signed Raw Transaction su Ethereum. La transazione deve essere specificata in formato esadecimale. Il link *More* offre link a servizi miscellanei. La voce *More* ha tre voci principali : *Tools*, *Explore*, *Services*. \
...
Le informazioni che si possono trovare sono molto estese e molto complete, ed è molto facile accedere ad esse. \
La barra di ricerca e il logo di Etherscan sono riproposti su ogni pagina. Cliccando sul logo si ritorna alla homepage. \
Complessivamente, Etherscan ha un'ottima usabilità.
[DA AGGIORNARE]
funzionalità per gli sviluppatori
chi fa scambi molto completa
...
- **Sviluppatori**: \
  ...
  - *Uno sviluppatore può verificare il codice del proprio smart contract ?* Sì, è possibile verificare il deploy di smart contract, è possibile ispezionare il codice. ulteriori strumenti per analisi del codice. &Egrave; possibile verficare interazioni con i contratti. \
...
- **Utenti individuali**: \
  *Questo utente può monitorare le sue attività ?* Sì, può consultare le tabelle, e i wallet \
  *Prendere decisioni di inverstimento ?* Sì 
  *Portare avanti piccole operazioni ?* No, si possono solo consultare i dati \ 

- **Sviluppatori**: \
  *creare la dApp ?* \
  *lanciare la dApp ?* \
  *fare auditing/valutazione della dApp ?* \
  *scrivere il codice ?* \
  *lanciare il codice ?* \
  *verificare il codice ?* Tabelle disponibili \
  

- **Minatori e Validatori** : \
  *monitorare la produzione di blocchi ?* Sì,  \
  *confermare delle transazioni ?* Sì \
  *monitorare la salute della rete ?* .. \
  *monitorare le attività della rete ?* Sì \

- **Analisti e ricercatori di cryptovalute** : \
  *monitorare i movimenti di mercato ?* \
  *esplorare i dati della blockchain ?* Sì\
  *analizzare le tendenze dei volumi delle transazioni ?* Sì \
  *prezzi del gas ?* Sì \
  *movimenti dei token ?* Sì \ 

- **Team di progetti (DeFi, NFT, Progetti Token)** : \
  *monitorare la liquidità dei token ?* sì \
  *le transazioni e le statistiche dei pool di liquidità ?* si \
  *creare l'NFT ?* \
  .. \
  *fare minting ?* \
  .. \
  *fare operazioni e monitorare lo stato ?* sì \
  .. \
  *lanciare i token o airdrop ?* \
  .. \
  *monitorare la distribuzione dei token ?* sì \
  .. \
  *verificare le interazioni con gli smart contract?* sì \
  .. \
  *gestire la tokenomica del progetto ?* sì \
  .. \
...
```
  ...
  *Prendere decisioni di inverstimento ?* 
  Prima di svolgere una transazione è possibile ottenere la stima del costo del gas [@aaron]: \
```{py, eval = FALSE}
transaction = {
...
```
  ...
  *Portare avanti piccole operazioni ?* Sì, è possibile completare transazioni scrivendo un codice Python. \ 
- **Sviluppatori**: \
  *creare la dApp ?* Sì, è possibile creare una dApp con il linguaggio Python e Web3.py risulta essere una libreria con funzionalità utili per questa implementazione. \
  *lanciare la dApp ?* Sì, se la dApp è uno script di Python è sufficiente eseguire il codice sul proprio dispositivo per interagire con la catena. \
  *fare auditing/valutazione della dApp ?* Sì, se la dApp è uno script di Python è possibile fare auditing dello script. \
  *scrivere il codice (smart contract) ?* Non direttamente, i smart contract sono scritti in Solidity oppure Vyper. QUesti script possono essere compilati utilizzando Python [@smartcontract]. \
  *lanciare il codice (smart contract) ?* Sì, è possibile compilare e lanciare uno smart contract utilizzando Python. La compilazione però non avviene con una funzione dalla libreria Web3 , bensì con la libreria solcx. Eseguire il deploy del contratto richiede una transazione. \
...
```
  ...
  *verificare il codice (smart contract) ?* Sì, è possibile verificare il codice. Verificare il codice richiede di compilare il codice dello smart contract localmente, scaricare il bytecode sulla catena, e confrontare i due.  E&grave; possibile compilare il codice, è possibile ottenere il bytecode con get_code() e si può scrivere uno script Python che confronta i due. \
- **Minatori e Validatori** : \
  *monitorare la produzione di blocchi ?* Sì, si possono invocare singoli blocchi, utilizzando il loro  numero oppure parole chiave ('latest', 'earliest', 'pending', 'safe', 'finalized'). \
  *confermare delle transazioni ?* Sì, si possono cercare specifiche transazioni. Si possono filtrare transazioni utilizzando TransactionFilter. \
  *monitorare la salute della rete ?* Sì, è possibile [come definire la salute di una blockchain] \
  *monitorare le attività della rete ?* Sì, è possibile interagire con i blocchi e con i contratti. \
- **Analisti e ricercatori di cryptovalute** : \
  *monitorare i movimenti di mercato ?* Non direttamente, si possono ottenere parte dei dati di interesse, ma sta all'utente rielaborarli. \
  *esplorare i dati della blockchain ?* Sì, si possono ottenere dati dei singoli blocchi. \
  *analizzare le tendenze dei volumi delle transazioni ?* Non direttamente \
  *prezzi del gas ?* Sì, estiste la Gas API. [ https://web3py.readthedocs.io/en/v4.10.0/gas_price.html#:~:text=The%20Gas%20Price%20API%20allows%20you%20to%20define,and%20returns%20a%20gas%20price%20%28denominated%20in%20wei%29. ]\
  *movimenti dei token ?* Sì, si possono cercare transazioni. \ 
- **Team di progetti (DeFi, NFT, Progetti Token)** : \
  *monitorare la liquidità dei token ?* No \
  *le transazioni e le statistiche dei pool di liquidità ?* Forse \
  .. \
  *creare l'NFT ?* \
  .. \
  *fare minting ?* \
  .. \
  *fare operazioni e monitorare lo stato ?* \
  .. \
  *lanciare i token o airdrop ?* \
  .. \
  *monitorare la distribuzione dei token ?* \
  .. \
  *verificare le interazioni con gli smart contract?* \
  .. \
  *gestire la tokenomica del progetto ?* \
  .. \

...
Dune offre quattro piani tariffari (aggiornato al 05/03/2025), che riguardano l'API: \
...
In questo progetto sono stati studiati quattro strumenti per interagire con le blockchain. Ogni strumento rappresenta un approcio differente: Etherscan rappresenta i Blockchain Explorer, Etherscan API rappresenta le Blockchain API, Dune Analytics rappresenta le piattaforme SQL, Web3.py rappresenta le librerie Web3. \
...
Usando gli strumenti separatamente è stato possibile ricostruire solo parte degli eventi legati al crollo del sistema Terra-Luna. Per ottenere un quadro completo che comprende tutti gli eventi sarebbe necessario combinare i risultati di più piattaforme. Questo permette di compensare le lacune delle singole piattaforme.

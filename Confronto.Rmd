...
I Blockchain Explorers forniscono interfacce pubbliche che permettono di ottenere informazioni sui dati della blockchain. L'interfaccia studiata è Etherscan. \
Etherscan  is the leading blockchain explorer, search, API and analytics platform for Ethereum, a decentralized smart contracts platform. [@docsetherscan]

![](images\Etherscan_homepage.png) <!-- {height=40%, width=40%} -->

Etherscan offre numerose funzionalità: \
- tracking : transaction, address, gas, price \
- smart contract interaction : \ 
- decentralized applications : \
- dettagli tokens: 
- blockchain explorer: ERC-20 and ERC-721 token tracking, token details, ERC-20 token transfers \
...
L'usabilità di Etherscan è stata valutata utilizzando i punti di Nielsen. \

- [riassunto della valutazione]

- Etherscan utilizza un linguaggio tecnico che presuppone conoscenze nel campo delle cryptovalute. \
- Non riechiede invece conoscenze di programmazione \
- Etherscan permette di interagire con i contratti \
- Consente di ottenere diverse informazioni sulla blockchain ma non di interagire con esse (creare blocchi, scrivere e caricare contratti) \
...
- quali informazioni sono disponibili ? \
  ...
  i gas fee
  le transazioni
  le cryptovalute hanno una loro pagina dedicata -> con quali informazioni
...
- non è possibile rielaborare i dati in qualche modo. &Egrave; possibile esportare parte i dati della blockchain

...
per creare chiavi è richiesta la creazione di un account. \

bisogna accedere alla propria area personale. \

Questa pagina propone un overview delle risorse e servizi utilizzati. \

![](images\Etherscan_myaccount.png){height=60%, width=60%}

la chiave API viene utilizzata direttamente negli url. \

&Egrave; disponibile una documentazione completa. \

Gli endpoints disponibili gratuitamente sono: \

*Accounts* \
- ottenere informazioni su specifici wallet conoscendo i loro hash address come il bilancio e il numero di transazioni. \
- ottenere informazioni su transazioni interne in base all'indirizzo, hash o intervallo di blocchi. \
- conoscendo l'indirizzo è possibile conscere il tipo di token trasferiti (ERC-20, ERC712 ERC1155). \
- è possibile conoscere l'elenco di blocchi validati da un indirizzo specifico \
- beacon chain withdrawal in base all'indirizzo oppure intervallo di blocchi \
- get historical ether balance for a single address for blockno \
...
creare facilmente chiavi. \

gli url si possono invocare direttamente nel browser. I risultati sono proposti su una pagina web. \

Per scaricare e manipolare i dati è stato necessario creare un codice Python e i output sono salvati come JSON. \
...
Stesse risorse disponibili con Etherscan. \

Interazione diretta con la blockchain. \

Ottenere un numero illimitato di entry (Etherscan ha un limite di 5000) . \
...
Esiste un set di API endpoints sempre disponibile. Questo viene esteso con ulteriori funzioni nei piani a pagamento. \
Il community support risulta sempre disponibile. A pagamento esiste anche il escalated support. \
Come si vede dalla figura sopra anche l'account gratuito offre una gamma completa di funzionalità.\
\
